...
class SemanticInterpreter:
    ...
    def interpret(self, disclosure: Disclosure) -> None:
        ...
        if "sözleşme" in text or "iş ilişkisi" in text:
            ...
            disclosure.real_value_point = "Tutarın şirketin mevcut faaliyet ölçeğine göre önemi ve kesinleşme durumu"
            ...
            disclosure.real_value_point = "Yatırımın yaratacağı ek gelir potansiyeli ve finansman yükü"
            disclosure.importance = DisclosureImportance.CRITICAL

        elif "finansal" in text or "bilanço" in text or "gelir tablosu" in text:
            disclosure.semantic_core = "Dönem finansal sonuçları"
            disclosure.real_value_point = "Net kar, ciro büyümesi ve operasyonel nakit akışı performansı"
            disclosure.importance = DisclosureImportance.CRITICAL
            ...
            disclosure.real_value_point = "Eski bilginin geçersiz kalması ve yeni etkinin hesaplanması"
            disclosure.importance = DisclosureImportance.MATERIAL
